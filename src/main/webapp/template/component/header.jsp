            ...
            <div class="header-menu">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">${cookie.USERNAME.value}</span>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="language-select dropdown" id="language-select">
                        <a class="dropdown-toggle" href="?language=en" data-toggle="dropdown"  id="language" aria-haspopup="true" aria-expanded="true">
                            <i class="flag-icon flag-icon-us"></i>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="language" >
                            <div class="dropdown-item">
                                <a href="?language=en"><i class="flag-icon flag-icon-us"></i></a>
                            </div>
                            <div class="dropdown-item">
                                <a href="?language=vi_VN"><i class="flag-icon flag-icon-vn"></i></a>
                            </div>
                        </div>
                    </div>
