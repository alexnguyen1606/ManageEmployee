...
<div class="right-panel" id="right-panel">
    ...
    <div class="col-lg-8">
        <h2>Employee</h2>
        <form:form action="/hr/add" method="post"  modelAttribute="viewmodel" cssClass="form-group">
            ...
            <form:select path="employee.type" cssClass="form-control">
                ...
                <form:option value="0">Nhân viên học việc</form:option>
            </form:select>
            ...
            <form:label path="birthDayString">Birth Day(01-01-2020):</form:label>
            ...
            <form:label path="employee.status"></form:label>
