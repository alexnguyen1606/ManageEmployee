...
<div class="right-panel" id="right-panel">
    ...
    <a href="/category/department/add"><i class="fa fa-plus fa-2x " style="margin-left: 10px;"></i></a>
    <br>
        ...
        <table class="table table-hover table-striped ">
            ...
            <c:forEach items="${departments}" var="department">
                <tr>
                    ...
                    <td>
                        <a href="/category/department/update/${department.id}"><i class="fa fa-edit"></i></a>
                        <a href="/category/department/delete/${department.id}" onclick="return confirm('Do you want to delete?')"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
