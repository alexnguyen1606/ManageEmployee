...
<div class="right-panel" id="right-panel">
    ...
    <div class="container">
        <div class="col-lg-9">
            ...
            <form:form action="/manage/user/add" modelAttribute="viewmodel" method="post" cssClass="form-group">
                <form:label path="user.username">Username:</form:label>
                <form:input path="user.username" cssClass="form-control" required="required"></form:input>
